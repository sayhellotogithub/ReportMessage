...
import com.iblogstreet.reportmessage.bean.PlayState;
import com.iblogstreet.reportmessage.settings.TtsSettings;
...
public class SpeechActivity extends Activity implements OnClickListener {
    ...
    private void initEvent() {
        mIvPlayPause.setOnClickListener(SpeechActivity.this);
        findViewById(R.id.stop).setOnClickListener(SpeechActivity.this);
        findViewById(R.id.image_tts_set).setOnClickListener(SpeechActivity.this);
        findViewById(R.id.tts_btn_person_select).setOnClickListener(SpeechActivity.this);
    ...
    public void switchPlayAndPauseImage(boolean isPause) {
        if (isPause) {
            mIvPlayPause.setImageResource(R.mipmap.pause);
        } else {
            mIvPlayPause.setImageResource(R.mipmap.play);
        }
    }

    private void initView() {
        mRadioGroup = ((RadioGroup) findViewById(R.id.tts_rediogroup));
        mSbProgress = findViewById(R.id.sbProgress);
        mIvPlayPause = findViewById(R.id.play_pause);
    }
        ...
        switch (view.getId()) {
            case R.id.image_tts_set:
                if (SpeechConstant.TYPE_CLOUD.equals(mEngineType)) {
                    Intent intent = new Intent(SpeechActivity.this, TtsSettings.class);
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
                    ...
                    if (code != ErrorCode.SUCCESS) {
                        ...
                        switchPlayAndPauseImage(true);
                    }
                } else if (playState == PlayState.PlAYING) {
                    playState = PlayState.PAUSE;
                    // 暂停播放
                    mTts.pauseSpeaking();
                    switchPlayAndPauseImage(false);
    ...
    private SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        public void onSpeakProgress(int percent, int beginPos, int endPos) {
            ...
            mSbProgress.setProgress(mPercentForPlaying);
